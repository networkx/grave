...
1. If you are a first-time contributor:
   ...
   * Go to `https://github.com/networkx/grave
     <https://github.com/networkx/grave>`_ and click the
...
<gitwash/index>` on how to use Git with ``grave``
(`<http://grave.readthedocs.io/en/latest/developer/gitwash/index.html>`_).
...
Please `report bugs on GitHub <https://github.com/networkx/grave/issues>`_.
