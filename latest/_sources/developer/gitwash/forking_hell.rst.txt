...
specifics for the `grave`_ project, and to suggest some default names.
...
Create your own forked copy of `grave`_
======================================================

#. Log into your github account.
#. Go to the `grave`_ github home at `grave github`_.
#. Click on the *fork* button:

   .. image:: forking_button.png

   Now, after a short pause, you should find yourself at the home page for
   your own forked copy of `grave`_.
